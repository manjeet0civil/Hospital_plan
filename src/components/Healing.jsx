   ...
   return (
      <>
        <div className="r-bottom">
                    <div className="hell">
                        <div className="four">
                            <div className="two-col center g20">
                                <div className="two-blue"> OUR DEPARTMENT</div>
                                <div className="two-head"> Our hospital has all kinds of departments, <br/>
                                      so you can get all kinds of treatment 
                                </div>
                                <div className="two-row g20">
                                    <div className="card relative">
                                       ...
                                       <div className="absolute">
                                            ...
                                            <div className="doc">nisi. Sed porttitor lectus nibh.</div>
                                       </div>
                                    </div>
                                    <div className="card relative">
                        ...
                        <div className="three">
                            <div className="two-col center g20">
                                <div className="two-blue"> OUR SPECIALISTS</div>
                                <div className="two-head"> We have all the professional specialists <br/>
                                      in our hospital 
                                </div>
                                <div className="two-row g20">
                                    <div className="card">
                        ...
                        <div className="two">
                            ...
                            <div className="two-two">
                                <div> 
                                    <div className="two-blue">who we are</div>
                                    <div className="two-head">We have been providing service to the patients for over 20 years</div>
                                    <div className="two-subhead"> Curabitur non nulla sit amet nisi tempus convallis quis ac lectus. Donec sollicitudin molestie malesuada. Nulla quis lorem ut libero malesuada feugiat. </div>
                                    <div className="two-row  g50">
                        ...
                        <div className="three two-row jfc">
                            <div className="sad w-90 bg-blog br5">
                                <span className="font40 bold mar50 pad20"> Hospility Status</span>
                                <div className="two-col  evenly">
